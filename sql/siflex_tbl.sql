...
CREATE TABLE tb_cobranca (
    ...
    discount_discountOne_value double DEFAULT NULL,
    discount_discountOne_limitDate date DEFAULT NULL,
    discount_discountTwo_value double DEFAULT NULL,
    discount_discountTwo_limitDate date DEFAULT NULL,
    discount_discountThree_value double DEFAULT NULL,
    discount_discountThree_limitDate date DEFAULT NULL,
    finePercentage double DEFAULT NULL,
    fineQuantityDays int DEFAULT NULL,
    interestPercentage double DEFAULT NULL,
    deductionValue double DEFAULT NULL,
    protestType varchar (17) DEFAULT NULL,
    protestQuantityDays int DEFAULT NULL,
    writeOffQuantityDays int DEFAULT NULL,
