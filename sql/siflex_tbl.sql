...
/* SANTANDER */
 ...
 DROP TABLE tb_cobranca;
CREATE TABLE tb_cobranca (
	nsuCode int(11) unsigned NOT NULL AUTO_INCREMENT,
	nsuDate date NOT NULL,
    environment varchar(8) NOT NULL DEFAULT "PRODUCAO",
    covenantCode int NOT NULL DEFAULT "1226029",
    payer_documentType varchar(4) NOT NULL DEFAULT "CNPJ",
    payer_documentNumber varchar(14) NOT NULL,
    payer_name varchar(40) NOT NULL,
    payer_address varchar(40) NOT NULL,
    payer_neighborhood varchar(30) NOT NULL,
    payer_city varchar(20) NOT NULL,
    payer_state varchar(2) NOT NULL,
    payer_zipCode varchar(9) NOT NULL,
    beneficiary_documentType varchar(4) DEFAULT "CNPJ",
    beneficiary_documentNumber varchar(14) DEFAULT "00519547000106",
    beneficiary_name varchar(40) DEFAULT "FLEXIBUS SANFONADOS LTDA.",    
    ...
    documentKind varchar(25) NOT NULL DEFAULT "DUPLICATA_MERCANTIL",
    discount_type varchar(15) DEFAULT NULL,
    discount_discountOne_value double DEFAULT 0,
    discount_discountOne_limitDate date DEFAULT NULL,
    discount_discountTwo_value double DEFAULT 0,
    discount_discountTwo_limitDate date DEFAULT NULL,
    discount_discountThree_value double DEFAULT 0,
    discount_discountThree_limitDate date DEFAULT NULL,
    finePercentage double DEFAULT 0,
    fineQuantityDays int DEFAULT 1,
    interestPercentage double DEFAULT 0,
    deductionValue double DEFAULT 0,
    protestType varchar (17) DEFAULT "SEM_PROTESTO",
    protestQuantityDays int DEFAULT 35,
    writeOffQuantityDays int DEFAULT 0,
    paymentType varchar(10) NOT NULL DEFAULT "REGISTRO",
    parcelsQuantity int DEFAULT NULL,
    valueType varchar(10) DEFAULT NULL,
    minValueOrPercentage double DEFAULT NULL,
    maxValueOrPercentage double DEFAULT NULL,
    iofPercentage double DEFAULT NULL,
    sharing_code varchar(2) DEFAULT NULL,
    sharing_value double DEFAULT NULL,
    key_type varchar(7) DEFAULT "CNPJ",
